...
<!-- Mirrored from themeht.com/template/seoland/ltr/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 00:56:11 GMT -->
<head>
...
<section class="overflow-hidden text-center vh-100 grediant-bg">
    ...
    <div class="row h-100 align-items-center">
      <div class="col-12">
        <div class="coming-soon">
          ...
          <h1 class="text-uppercase mt-4 mb-2 text-theme">Coming <span class="text-black">Soon</span>
          </h1>
          <p>We Are Creatinig Something Awesome And Exciting For You</p>
          <ul class="countdown list-inline text-black" data-countdown="2024/10/23"></ul>
          <div>
