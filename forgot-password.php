...
<!-- Mirrored from themeht.com/template/seoland/ltr/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 00:56:42 GMT -->
<head>
...
<!-- Title -->
<title>SpeedX Digital Marketing Agency </title>
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="nav navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link active dropdown-toggle" href="#" data-bs-toggle="dropdown">Shop</a>
                  <ul class="dropdown-menu">
                    <li>
...
<nav id="ht-main-nav">
  ...
  <a class="navbar-brand logo" href="index.html">
    <img class="img-fluid" src="images/logo.svg" alt=""> </a>
  <p class="mt-3">Seoland Digital Marketing Agency Template Is fully responsible, Build whatever you like with the Seoland, Seoland is the creative, modern  suitable for Your Business Marketing.</p>
  <div class="form-info">
    ...
    <div class="row justify-content-center text-center">
      <div class="col-lg-6">
        <div>
          ...
          <form class="px-sm-10" id="contact-form" method="post" action="https://themeht.com/template/seoland/ltr/php/contact.php">
            <div class="messages"></div>
            <div class="mb-3">
              <input id="form_email" type="email" name="email" class="form-control" placeholder="Email Address" required>
            </div> <button class="themeht-btn primary-btn"><span>Forgot Now</span><i class="bi bi-arrow-right"></i></button>
          </form>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-7 pe-lg-8">
          ...
          <p class="mt-4 mb-5">Seoland Digital Marketing Agency Template Is fully responsible, Build whatever you like with the Seoland, Seoland is the creative, modern  suitable for Your Business Marketing.</p>
...
<!-- Mirrored from themeht.com/template/seoland/ltr/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 00:56:43 GMT -->
</html>
