        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 order-lg-1 ps-lg-8">
            <div class="banner-img animate__animated animate__fadeInRight animate__slow">
              <img class="img-fluid" src="images/banner/01.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 col-md-12 mt-10 mt-lg-0">
            ...
            <p class="lead mb-5 animate__animated animate__zoomIn animate__slow">Elevate your online presence with SPEED-X! We offer customized digital marketing
              solutions designed to deliver real results. Whether you're a startup building
              your brand or an established business seeking growth, we have the expertise to
              help you succeed.</p>
          ...
          <div class="row gx-5">
            <div class="col-lg-4 col-md-6">
              <div class="featured-item style-1 text-center">
                ...
                <div class="featured-desc">
                  <p>Build authority and credibility with valuable content that resonates with your audience.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-6 mt-md-0">
              <div class="featured-item style-1 featured-active text-center">
                ...
                <div class="featured-desc">
                  <p>Engage with your audience on popular social media platforms.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-6 mt-lg-0">
              <div class="featured-item style-1 text-center">
                ...
                <div class="featured-desc">
                  <p>Dominate search engine rankings and increase organic traffic with our expert SEO strategies. </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
              <div class="shape-img-bg">
                <img class="mask-img" src="images/about/01.jpg" alt="">
  ...
  c-15.2-15.1,0.3-41.7-16.6-54.9C63,186,49.7,196.7,37.5,186z  " />
            ...
            <div class="col-lg-6 col-md-12 mt-6 mt-lg-0 ps-lg-10">
              <div class="theme-title mb-4">
                ...
                <p>SPEED-X agency makes it easy to create content that engages your audience by taking the guesswork out
                  of research, strategy, and writing.</p>
              </div>
              <div class="row">
            ...
            <div class="col-lg-7 ps-lg-8">
              <div class="row">
                  ...
                  <div class="service-item style-1">
                    <div class="service-item-inner">
                      ...
                      <div class="service-desc">
                        ...
                        <p>Our strategy includes consistently evolving, to ensure we’re SEO for business. Get more
                          traffic with powerful SEO services.</p>
                ...
                <div class="col-md-6 mt-6 mt-md-0">
                  ...
                  <a class="themeht-btn secondary-btn mt-5" href="services.php">
                    <span>Discover More</span>
                    <i class="bi bi-arrow-right"></i>
                  </a>
                </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 order-lg-1">
              <div class="shape-img-bg">
                <img class="mask-img" src="images/about/03.jpg" alt="">
                <div class="img-bg-shape">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 288 288">
            ...
            <div class="col-lg-6 col-md-12 mt-6 mt-lg-0 pe-lg-10">
              <div class="theme-title mb-4">
                ...
                <p>Scale your software operations through a custom engineering team. Meet the demand of your company’s
                  operations with a high-performing nearshore team skilled in the technologies you need.</p>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mt-6 mt-md-0">
              <div class="step-item style-1 text-white step-bg">
                ...
                <h4>Customize</h4>
                <p class="mb-0">setting up customized tracking parameters that align with your objectives</p>
                <span>2nd Step</span>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 mt-6 mt-lg-0">
              <div class="step-item style-1 text-white">
                ...
                <h4>Targeting</h4>
                <p class="mb-0">setting up targeted tracking for different user groups, channels that are critical to your business.</p>
                <span>3rd Step</span>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 mt-6 mt-lg-0">
      ...
      <section class="overflow-hidden p-0" style="margin-top:80PX">
        <div class="container-fluid p-0">
          <div class="row">
            <div class="col">
              <div class="marquee-wrap">
                ...
                <div class="grid-item cat3">
                  <div class="portfolio-item">
                    ...
                    <div class="portfolio-title">
                      <span>Branding</span>
                      <h4><a href="#"></a>SEO Tracking Analysis</h4>
                    </div>
                  </div>
                </div>
                <div class="grid-item cat3">
                  <div class="portfolio-item">
                    ...
                    <div class="portfolio-title">
                      <span>Branding</span>
                      <h4>
                        <a href="#">Email Marketing Solution</a>
                      </h4>
                    </div>
                  </div>
                </div>
                <div class="grid-item cat4">
                  <div class="portfolio-item">
                    ...
                    <div class="portfolio-title">
                      ...
                      <h4>
                        <a href="#">Offline SEO Marketing</a>
                      </h4>
                    </div>
                  </div>
                </div>
                <div class="grid-item cat2">
                  <div class="portfolio-item">
                    ...
                    <div class="portfolio-title">
                      <span>Marketing</span>
                      <h4>
                        <a href="#">Article Data Analysis</a>
                      </h4>
                    </div>
                  </div>
                </div>
                ...
                <div class="testimonial-box">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="testimonial style-2">
                       ...
                       //<div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
                            Praesent sed nisi eleifend, adipisicing elit.</p>
                    ...
                    <div class="carousel-item">
                      <div class="testimonial style-2">
                        <div class="testimonial-img">
                          <img class="img-fluid" src="images/testimonial/02.jpeg" alt="">
                        </div>
                        <div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
                    ...
                    <div class="carousel-item">
                      <div class="testimonial style-2">
                        <div class="testimonial-img">
                          <img class="img-fluid" src="images/testimonial/05.jpg" alt="">
                        </div>
                        <div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
                    ...
                    <div class="carousel-item">
                      <div class="testimonial style-2">
                        <div class="testimonial-img">
                          <img class="img-fluid" src="images/testimonial/06.jpg" alt="">
                        </div>
                        <div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
                    ...
                    <div class="carousel-item">
                      <div class="testimonial style-2">
                        <div class="testimonial-img">
                          <img class="img-fluid" src="images/testimonial/07.jpg" alt="">
                        </div>
                        <div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
                    ...
                    <div class="carousel-item">
                      <div class="testimonial style-2">
                        <div class="testimonial-img">
                          <img class="img-fluid" src="images/testimonial/08.jpg" alt="">
                        </div>
                        <div class="testimonial-desc">
                          <p>Speed-XAmazing Landing Page All-in-one, clean code, Crative & Modern design Professional
                            Recommended crofessional and great experience, Nam pulvinar vitae neque et porttitor,
          ...
          <div class="row align-items-end mb-8">
            <div class="col-lg-6 col-md-12">
              <div class="theme-title mb-0">
                ...
                <p>Our campaigns get your business in front of the right people at the right time to increase organic
                  traffic and boost engagement. </p>
              </div>
            </div>
            <div class="col-lg-6 col-md-12 text-end">
              <a class="themeht-btn primary-btn" href="blog-right-sidebar.php">
            ...
            <div class="col-lg-4 col-md-12">
              <div class="post-card">
                ...
                <div class="post-image">
                  ...
                  <a class="post-btn" href="blog-single.php">
                ...
                <div class="post-desc">
                  <div class="post-title">
                    <h4>
                      <a href="blog-single.php">Simple ways to Optimize Website For SEO</a>
                    </h4>
                  </div>
            ...
            <div class="col-lg-4 col-md-12 mt-6 mt-lg-0">
              <div class="post-card">
                ...
                <div class="post-desc">
                  <div class="post-title">
                    <h4>
                      <a href="blog-single.php">How Chatbots Can Help You Drive More Sales</a>
                    </h4>
                  </div>
                  <p>SEO strategies people are getting themselves enrolled in coding and on their own....</p>
                  <div class="post-date"> 04 Mar, 2024 </div>
            ...
            <div class="col-lg-4 col-md-12 mt-6 mt-lg-0">
              <div class="post-card">
                ...
                <div class="post-desc">
                  <div class="post-title">
                    <h4>
                      <a href="blog-single.php">Leveraging Feedback on Insights best SEO</a>
                    </h4>
                  </div>
                  <p>SEO strategies people are getting themselves enrolled in coding and on their own....</p>
                  <div class="post-date"> 04 Mar, 2024 </div>
